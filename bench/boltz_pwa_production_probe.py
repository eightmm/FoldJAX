...
def run_production(source, inputs, weights, out):
    import jax
    ...
    with jax.default_matmul_precision("highest"):
        compiled = (
            jax.jit(production_forward, compiler_options=options)
...
def main():
    ...
    try:
        result, runtime = run_production(source, inputs, weights, out)
