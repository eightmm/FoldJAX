...
Parses A3M MSA files into the MSA dataclass. Imports remapped to foldjax.models.boltz2.
"""
...
from foldjax.models.boltz2.data.types import MSA, MSADeletion, MSAResidue, MSASequence
