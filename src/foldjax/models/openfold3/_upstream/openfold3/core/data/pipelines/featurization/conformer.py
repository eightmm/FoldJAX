...
from foldjax.models.openfold3._upstream.openfold3.core.data.primitives.structure.component import PERIODIC_TABLE
from foldjax.models.openfold3._upstream.openfold3.core.model.structure.augmentation import centre_random_augmentation
