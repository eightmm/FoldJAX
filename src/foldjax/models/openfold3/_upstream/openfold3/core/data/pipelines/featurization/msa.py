...
from foldjax.models.openfold3._upstream.openfold3.core.data.primitives.featurization.msa import (
...
from foldjax.models.openfold3._upstream.openfold3.core.data.primitives.sequence.msa import MsaArrayCollection
