...
from foldjax.models.openfold3._upstream.openfold3.core.data.primitives.featurization.padding import pad_token_dim
...
from foldjax.models.openfold3._upstream.openfold3.core.data.primitives.featurization.template import (
