...
from foldjax.models.openfold3._upstream.openfold3.core.data.framework.data_module import DatasetMode, DatasetSpec
from foldjax.models.openfold3._upstream.openfold3.core.data.pipelines.preprocessing.template import (
    TemplatePreprocessorSettings,
)
from foldjax.models.openfold3._upstream.openfold3.projects.of3_all_atom.config.dataset_config_components import (
    ChainCropSettings,
    CropSettings,
    CropWeights,
    LossConfig,
...
class DefaultDatasetConfigSection(BaseModel):
    ...
    Datasets for this project are defined in
      `foldjax.models.openfold3._upstream.openfold3.core.data.framework.single_datasets`
